...
public class IntegrationControllerTest extends JerseyTest {
    ...
    @Test
    public void test() throws LetterFailedExceptionException, CreateCustomerFailedException, CreateAgreementFailedException, UpdateAgreementStatusFailedException {
        // Given:
    ...
    public void createAgreementWithBadCustomerPid() {
        ...
        assertEquals("{\"errors\":[{\"field\":\"createAgreement.arg0.customerPid\",\"message\":\"size must be between 1 and 11\"}]}",
                response.readEntity(String.class));
    }
    ...
    public void createAgreementWithBadAgreementPrice() {
        ...
        // Then:
        assertEquals(400, response.getStatus());
        assertEquals("{\"errors\":[{\"field\":\"createAgreement.arg0.agreementPrice\",\"message\":\"must be greater than or equal to 1\"}]}",
                response.readEntity(String.class));
    }
    ...
    public void createAgreementWithBadCustomerName() {
        ...
        // Then:
        assertEquals(400, response.getStatus());
        assertEquals("{\"errors\":[{\"field\":\"createAgreement.arg0.customerName\",\"message\":\"size must be between 1 and 100\"}]}",
                response.readEntity(String.class));
    }
